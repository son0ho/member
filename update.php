...
<div class="loginmodal-container">
    ...
    <form action="./updateok.php" method="post">
        ...
        <input type="text" name="user" placeholder="새 아이디" value="<?php echo $user; ?>">
        <input type="password" name="pass" placeholder="새 비밀번호" value="<?php echo $pass; ?>">
        <input type="text" name="name" placeholder="이름" value="<?php echo $name; ?>">
        <input type="text" name="tel" placeholder="연락처" value="<?php echo $tel; ?>">
